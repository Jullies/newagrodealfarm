...
<!-- Mirrored from themesflat.co/html/donalfarm/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:41:07 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                        ...
                        <div class="header-topbar">
                            ...
                            <div class="header-right">
                                ...
                                <div class="icon-wrap">
                                    ...
                                    <a href="#log" data-bs-toggle="modal" class="icon style-circle">
                                        <i class="icon-user"></i>
                                    </a>
                                    <a href="#wishlist" class="icon style-circle" data-bs-toggle="modal">
                                        <i class="icon-heart111"></i>
                                    </a>
                                    <a href="#addcart" class="icon style-circle wg-bag" data-bs-toggle="modal">
                                            ...
                                            <li class="item has-child current-menu">
                                                ...
                                                <ul class="sub-nav">
                                                    ...
                                                    <li class="current-item"><a
                                                            href="checkout.php"><span>Checkout</span></a></li>
                        ...
                        <ul id="menu-mobile-menu" class="menu">
                            ...
                            <li class="menu-item menu-item-has-children-mobile">
                                ...
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item">
                                        <a href="index.php">Portfolio Detail</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children-mobile">
                                ...
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item "><a href="shop-products.php">Shop Product</a></li>
                                    <li class="menu-item "><a href="shop-details.php">Shop Detail</a></li>
                                    <li class="menu-item "><a href="shop-cart.php">Shop Cart</a></li>
                                    <li class="menu-item "><a href="wishlist.php">Wishlist</a></li>
                                    <li class="menu-item current"><a href="checkout.php">Checkout</a></li>
                                    <li class="menu-item "><a href="order-tracking.php">Order Tracking</a></li>
                                    <li class="menu-item "><a href="my-account.php">My Account</a></li>
                                    <li class="menu-item "><a href="order-details.php">Order Detail</a></li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children-mobile">
                                <a class="item-menu-mobile" href="javascript:void(0)">
        ...
        <section class="flat-spacing-1">
            <div class="tf-container">
                <div class="row">
                        ...
                        <div class="tf-page-checkout">
                            <div class="tf-cols">
                                <div class="cols-12 cols-md-6">
                                    <a href="#log" data-bs-toggle="modal" class="tf-btn-nor style-2  w-100">
                                        <i class="fa-solid fa-user"></i>
                                        Log In Your Account
                                    </a>
                                </div>
                                <div class="cols-12 cols-md-6">
                                    <form action="#" class="form-coupon form-def">
                                        <fieldset>
                                            <input type="text" placeholder="Enter promo code" required>
                                        </fieldset>
                                        <div class="button-submit">
                                            <button type="submit" class="link">
                                                <span class="font-worksans">Apply</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="wrap">
                                <h5 class="title fw-bold">Billing details</h5>
                                <form action="#" class="form-def form-payment">
                                    <div class="cols flex-wrap flex-sm-nowrap">
                                        <fieldset>
                                    ...
                                    <fieldset>
                                        <textarea placeholder="Order note (optional)" style="height: 130px;"></textarea>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="tf-sidebar-cart">
                            <div class="box-order">
                                <p class="title text-main-2 fw-bold">Your order</p>
                                <ul class="review-order-list ">
                                    <li>
                                ...
                                <div class="subtotal d-flex justify-content-between align-items-center">
                                    <p>Subtotal</p>
                                    <p class="total text-main-2">114.00$</p>
                                </div>
                                <h5
                                    class="total-order has-bt fw-medium d-flex justify-content-between align-items-center">
                                    <span>Total</span>
                                    <span class="total">114.00$</span>
                                </h5>
                                <div class="payment-box has-bt" id="accordionPayMethod">
                                    <div class="payment-item">
                                        <label for="delivery-method1" class="payment-header radio-item"
                                            data-bs-toggle="collapse" data-bs-target="#accordionPayMethod-One"
                                            aria-controls="accordionPayMethod-One" aria-expanded="true">
                                            <input type="radio" name="payment-method" class="tf-check-rounded"
                                                id="delivery-method1" checked>
                                            <span class="text-def text-main-2 fw-medium">Direct bank transfer
                                            </span>
                                        </label>
                                        <div id="accordionPayMethod-One" class="accordion-collapse collapse show"
                                            data-bs-parent="#accordionPayMethod">
                                            <p class="text-small sub-payment">
                                    ...
                                    <div class="payment-item">
                                        <label for="delivery-method2" class="payment-header radio-item collapsed"
                                            data-bs-toggle="collapse" data-bs-target="#accordionPayMethod-Two"
                                            aria-controls="accordionPayMethod-Two" aria-expanded="false">
                                            <input type="radio" name="payment-method" class="tf-check-rounded"
                                                id="delivery-method2">
                                            <span class="text-def text-main-2 fw-medium">Check payments</span>
                                        </label>
                                        <div id="accordionPayMethod-Two" class="collapse"
                                            data-bs-parent="#accordionPayMethod">
                                            <p class="text-small sub-payment">
                                    ...
                                    <div class="payment-item">
                                        <label for="delivery-method3" class="payment-header radio-item collapsed"
                                            data-bs-toggle="collapse" data-bs-target="#accordionPayMethod-Three"
                                            aria-controls="accordionPayMethod-Three" aria-expanded="false">
                                            <input type="radio" name="payment-method" class="tf-check-rounded"
                                                id="delivery-method3">
                                            <span class="text-def text-main-2 fw-medium">Cash on delivery</span>
                                        </label>
                                        <div id="accordionPayMethod-Three" class="collapse"
                                            data-bs-parent="#accordionPayMethod">
                                            <p class="text-small sub-payment">
