                ...
                <div class="tf-container w-1290">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content">
                                <p class="sub-title">
                                    Talk with New Agrodeal Kenya Limited
                                </p>
                                <h1 class="title">
                                    Contact Us
                                </h1>
                            ...
                            <div class="col-lg-7">
                                <div class="content-section">
                                    <div class="heading-section has-text mb-50">
                                        ...
                                        <p class="text">
                                            Tell us your destination market, weekly volumes, and packaging preference.
                                            We respond quickly with export-ready options across basil, mint, coriander,
                                            chives, tarragon, specialty herbs, and Gypsophila.
                                        </p>
                                        <div class="img-item">
                                        ...
                                        <div class="cols style-2 mb-15">
                                            ...
                                            <fieldset class="dropdown">
                                                <select name="text" id="Support">
                                                    <option value="Product Inquiry" selected="">Product inquiry (herbs / flowers)</option>
                                                    <option value="Volume & Scheduling">Volumes, specs & scheduling</option>
                                                    <option value="Logistics">Logistics / cold chain coordination</option>
                                                    <option value="Partnerships">Partnerships & sourcing</option>
                                                </select>
                                            </fieldset>
                                        </div>
