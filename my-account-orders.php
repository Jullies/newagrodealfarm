...
<!-- Mirrored from themesflat.co/html/donalfarm/my-account-orders.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:41:31 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                        ...
                        <div class="my-account-content account-order">
                            <div class="wrap-account-order">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="fw-semibold text-def text-main-2">Order</th>
                                            <th class="fw-semibold text-def text-main-2">Date</th>
                                            <th class="fw-semibold text-def text-main-2">Status</th>
                                            <th class="fw-semibold text-def text-main-2">Total</th>
                                            <th class="fw-semibold text-def text-main-2">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="tf-order-item">
                                            <td class="text-small">#123</td>
                                            <td class="text-small">August 1, 2024</td>
                                            <td class="text-small">On hold</td>
                                            <td class="text-small">$200.0 for 1 items</td>
                                            <td>
                                                <a href="order-details.php" class="tf-btn-nor style-2 style-small">
