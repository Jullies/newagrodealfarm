...
<!-- Mirrored from themesflat.co/html/donalfarm/our-history.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:01 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="heading-section text-center">
                                ...
                                <p class="text font-snowfall fs-30 ">
                                    Beginning in 1993, Feast of Fields has grown to be the greatest local food
                                    celebration in Canada. Feast events are designed <br> to connect city folks with the
                                    chefs, farmers, fishers, ranchers, and food artisans that feed them. Each host farm
                                    transforms <br> into a gourmet harvest festival.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="gallery-item img-hover wow fadeInUp" data-wow-delay="0s">
                                            <div class="image hover-item">
                                                <img class=" lazyload" src="images/widget/history-1.jpg"
                                                    data-src="./images/widget/history-1.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">
                                                +
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="gallery-item img-hover wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="image hover-item">
                                                <img class=" lazyload" src="images/widget/history-2.jpg"
                                                    data-src="./images/widget/history-2.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">
                                                +
                                            </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="gallery-item img-hover wow fadeInUp" data-wow-delay="0.2s">
                                            <div class="image hover-item">
                                                <img class=" lazyload" src="images/widget/history-3.jpg"
                                                    data-src="./images/widget/history-3.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">
                                                +
                                            </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="gallery-item img-hover wow fadeInUp" data-wow-delay="0.3s">
                                            <div class="image hover-item">
                                                <img class=" lazyload" src="images/widget/history-4.jpg"
                                                    data-src="./images/widget/history-4.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">
                                                +
                                            </a>
                            ...
                            <div class="main-history">
                                ...
                                <div class="wg-history mb-50 type-left">
                                    <div class="image type-1">
                                        <img src="images/widget/our-history-1.jpg"
                                            data-src="./images/widget/our-history-1.jpg" alt="" class="lazyload">
                                    </div>
                                    <div class="year">
                                ...
                                <div class="wg-history mb-50 type-right img-hover  tf-img-hover">
                                    ...
                                    <div class="image hover-item hover14">
                                        <img src="images/widget/our-history-2.jpg"
                                            data-src="./images/widget/our-history-2.jpg" alt="" class="lazyload">
                                    </div>
                                </div>
                                <div class="wg-history mb-50 type-left img-hover tf-img-hover">
                                    <div class="image hover-item hover14">
                                        <img src="images/widget/our-history-3.jpg"
                                            data-src="./images/widget/our-history-3.jpg" alt="" class="lazyload">
                                    </div>
                                    <div class="year ">
                                        <p class="number font-snowfall fs-30">
                                            1933
                                ...
                                <div class="wg-history mb-50 type-right img-hover tf-img-hover">
                                    ...
                                    <div class="image hover-item hover14">
                                        <img src="images/widget/our-history-4.jpg"
                                            data-src="./images/widget/our-history-4.jpg" alt="" class="lazyload">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from themesflat.co/html/donalfarm/our-history.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:09 GMT -->
</html>
