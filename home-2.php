...
<!-- Mirrored from themesflat.co/html/donalfarm/home-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:38:47 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body class="counter-scroll-2">
    ...
    <div id="wrapper" class="wrapper-home-2">
        ...
        <div class="bg-page absolute">
            <div class="image">
                <img class="lazyload" src="images/item/yellow-field.jpg" alt="">
            </div>
        </div><!-- /.Bg-page -->
        ...
        <div class="header-wrap absolute">
                                ...
                                <div class="topbar-left">
                                    <div class="logo">
                                        <a href="index.php">
                                            ...
                                            <img src="images/logo/logo.png" data-src="./images/logo/logo-2.png" alt=""
                                                class="lazyload">
                                        </a>
                                    </div>
                                </div>
            ...
            <!-- Header -->
            <header class="header style-2" id="header-main">
                <div class="tf-container w-1620">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header-inner">
                                        ...
                                        <ul class="nav-list">
                                            <li class="item has-child current-menu">
                                                ...
                                                <ul class="sub-nav">
                                                    ...
                                                    <li class="current-item"><a href="home-2.php"><span>
                                                                Home 2
                                                            </span>
                                                        </a></li>
                                ...
                                <div class="header-right">
                                    ...
                                    <a href="contact-us.php" class="tf-btn bg-white gap-30">
                                    ...
                                    <div class="top">
                                        ...
                                        <nav id="mobile-main-nav" class="mobile-main-nav">
                                            <ul id="menu-mobile-menu" class="menu">
                                                <li class="menu-item menu-item-has-children-mobile current">
                                                    ...
                                                    <ul class="sub-menu-mobile">
                                                        ...
                                                        <li class="menu-item current"><a href="home-2.php">Home 2</a>
                                                        </li>
                                                ...
                                                <li class="menu-item menu-item-has-children-mobile">
                                                    ...
                                                    <ul class="sub-menu-mobile">
                                                        ...
                                                        <li class="menu-item"><a href="portfolio-style-3.php">Portfolio
                                                                Style 3</a></li>
                                                        <li class="menu-item "><a href="index.php">Portfolio Detail</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item menu-item-has-children-mobile">
                                                    ...
                                                    <ul class="sub-menu-mobile">
                                                        ...
                                                        <li class="menu-item"><a href="shop-products.php">Shop
                                                                Product</a>
                                                        </li>
                                                        <li class="menu-item"><a href="shop-details.php">Shop
                                                                Detail</a>
                                                        </li>
                                                        ...
                                                        <li class="menu-item"><a href="order-details.php">Order
                                                                Detail</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="menu-item menu-item-has-children-mobile">
                                                    ...
                                                    <ul class="sub-menu-mobile">
                                                        ...
                                                        <li class="menu-item "><a href="blog-single.php">Blog
                                                                Single</a>
                                                        </li>
                                                    </ul>
                                                </li>
                ...
                <div class="fixed-header style-absolute style-2">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="header-inner">
                                    <div class="header-left">
                                        <div class="logo">
                                            <a href="index.php">
                                                ...
                                                <img src="images/logo/logo.png" data-src="images/logo/logo.png"
                                                    alt="" class="lazyload">
                                            </a>
                                        </div>
                                        <div class="main-nav">
                                            <ul class="nav-list">
                                                ...
                                                <li class="item has-child">
                                                    <a href="javascript:void(0)">Shop</a>
                                                    <ul class="sub-nav">
                                                        <li><a href="shop-products.php"><span>Shop Products</span></a>
                                                        </li>
                                                        <li><a href="shop-details.php"><span>Shop Details</span></a>
                                                        </li>
                                                        <li><a href="shop-cart.php"><span>Shop Cart</span></a></li>
                                                        <li><a href="wishlist.php"><span>Wishlist</span></a></li>
                                                        <li><a href="checkout.php"><span>Checkout</span></a></li>
                                                        <li><a href="order-tracking.php"><span>Order
                                                                    Tracking</span></a>
                                                        </li>
                                                        <li><a href="my-account.php"><span>My Account</span></a></li>
                                                        <li><a href="order-details.php"><span>Order Detail</span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="item has-child">
                                    ...
                                    <div class="header-right">
                                        <div class="icon-wrap">
                                            <a class="icon header-search" href="#canvasSearch"
                                                data-bs-toggle="offcanvas">
                                                <i class="icon-magnifying-glass fs-21"></i>
                                            </a>
                    ...
                    <div class="header-item children absolute">
            ...
            <div class="swiper-container slider-home-2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-home-2">
                            ...
                            <div class="content">
                                ...
                                <a href="our-services.php" class="tf-btn btn-view bg-white tf-fade-bottom fade-item-5">
                                    <span class="text-style cl-primary">
                                        See Our Services
                                    </span>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-home-2">
                            <div class="image overflow-hidden">
                                <img src="images/page-title/home-2-2.jpg" data-src="images/page-title/home-2-2.jpg"
                                    alt="" class="lazyload tf-animate-zoom-in-out">
                            </div>
                            <div class="content">
                                <h1 class="title  font-farmhouse tf-fade-top fade-item-2">
                ...
                <div class="swiper-container slider-s-service-2">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="box-infor style-2 ic-hover img-hover">
                                <div class="image hover-icon hover-item">
                                    <img src="images/widget/provide-item-2-2.jpg"
                                        data-src="./images/widget/provide-item-2-2.jpg" alt="" class=" lazyload">
                                    <div class="icon style-circle">
                                        <i class="icon-cow"></i>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="box-infor style-2 ic-hover img-hover">
                                <div class="image hover-icon hover-item">
                                    <img src="images/widget/provide-item-3-3.jpg"
                                        data-src="./images/widget/provide-item-3-3.jpg" alt="" class=" lazyload">
                                    <div class="icon style-circle">
        ...
        <section class="s-what-we-do ">
            <div class="content-wrap">
                <div class="content-section">
                    ...
                    <a href="about-us.php" class="tf-btn bg-white">
                        <span class="text-style cl-primary">
                            Read More
                        </span>
                        <div class="icon">
                        ...
                        <div class="wrap">
                            ...
                            <div class="box-event style-2 ic-hover wow fadeInUp" data-wow-delay="0s">
                                <div class="content hover-icon-2">
                                    ...
                                    <a href="service-detail.php" class="title fw-6 font-worksans hover-text-4">
                                        Farmers
                                    </a>
                                        ...
                                        <div class="box-portfolio style-5">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bot">
                                                    ...
                                                    <a href="portfolio-style-1.php" class="btn-read icon style-circle">
                                                        <i class="icon-arrow_right"></i>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="box-portfolio style-5">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bot">
                                                    ...
                                                    <a href="portfolio-style-2.php" class="btn-read icon style-circle">
                                                        <i class="icon-arrow_right"></i>
                                                    </a>
                                                </div>
                                            </div>
        ...
        <section class="s-happy-farm">
            <div class="bg-section">
                <div class="scroll-element-3">
                    <img class="lazyload  scale-1-1" src="images/item/gree-field.jpg"
                        data-src="./images/item/gree-field.jpg" alt="">
                </div>
                <div class="s-img-item item-1">
                    <img src="images/item/page-title-top.png" alt="">
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                ...
                                <div class="image-wrap">
                                    <img src="images/section/s-hp-farm.png" data-src="images/section/s-hp-farm.png"
                                        alt="" class="lazyload">

                                </div>
                                <div class="img-item item-1 nhapNhap">
                                    <img src="images/item/house-mountain-2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themesflat.co/html/donalfarm/home-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:39:08 GMT -->
</html>
