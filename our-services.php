                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="content-section">
                                ...
                                <p class="text">
                                    We supply export-quality Basil, Mint, Coriander, Chives, Tarragon, and specialty
                                    herbs (Dill, Oregano, Rosemary, Thyme, Parsley, Sage, Marjoram, Rucola, Lovage,
                                    Red/Thai Basil) plus Gypsophila flowers. Every order is harvested at peak aroma,
                                    graded for uniformity, and packed to your specifications with a cold-chain mindset.
                                </p>
                                <ul class="benefit-list">
                                    ...
                                    <li>
                                        ...
                                        <p>Harvested at peak freshness for superior flavor and aroma</p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <i class="fa-solid fa-circle-check"></i>
                                        </div>
                                        <p>Careful grading and packing for consistent export quality</p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <i class="fa-solid fa-circle-check"></i>
                                        </div>
                                        <p>Reliable supply aligned to customer specifications</p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <i class="fa-solid fa-circle-check"></i>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box-icon ic-hover wow fadeInUp" data-wow-delay="0.1s">
                                                ...
                                                <p class="text font-nunito">
                                                    Peak-freshness harvesting, uniform grading, and export packing you
                                                    can rely on.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box-icon ic-hover wow fadeInUp" data-wow-delay="0.3s">
                                                ...
                                                <p class="text font-nunito">
                                                    Consistent volumes, responsive coordination, and competitive export
                                                    programs tailored to your market.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
