...
<!-- Mirrored from themesflat.co/html/donalfarm/my-account-address.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:41:31 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                    ...
                    <div class="col-lg-12">
                        <div class="header-inner">
                            ...
                            <div class="header-right">
                                <a href="contact-us.php" class="tf-btn gap-30">
                    ...
                    <div class="col-lg-9">
                        <div class="my-account-content account-address">
                            <div class="text-center widget-inner-address">
                                <button class="tf-btn-nor style-small btn-address mb-20">
                                    Add a new address
                                </button>
                                <form class="show-form-address wd-form-address mb-20" id="formeditAddress" action="#">
                                    <h3 class="title mb-20">Add a new address</h3>
                                    <div class="form-content mb-20">
                                        <div class="cols gap-10">
                                            ...
                                            <fieldset>
                                                <input type="email" id="mail" name="mail" placeholder="Last name"
                                                    required />
                                            </fieldset>
                                        </div>
                                        <fieldset>
                                            <input type="text" placeholder="Company" aria-required="true" required />
                                        </fieldset>
                                        <fieldset>
                                            ...
                                            <div class="select-custom">
                                                <select class="tf-select-2 w-100" id="countryEdit"
                                                    ...
                                                    <option value="New Zealand"
                                                        data-provinces="[['Auckland','Auckland'],['Bay of Plenty','Bay of Plenty'],['Canterbury','Canterbury'],['Chatham Islands','Chatham Islands'],['Gisborne','Gisborne'],['Hawke's Bay','Hawkeâ€™s Bay'],['Manawatu-Wanganui','ManawatÅ«-Whanganui'],['Marlborough','Marlborough'],['Nelson','Nelson'],['Northland','Northland'],['Otago','Otago'],['Southland','Southland'],['Taranaki','Taranaki'],['Tasman','Tasman'],['Waikato','Waikato'],['Wellington','Wellington'],['West Coast','West Coast']]">
                                                        New Zealand</option>
                                                    <option value="Norway" data-provinces="[]">Norway</option>
                                                    <option value="Poland" data-provinces="[]">Poland</option>
                                                    <option value="Portugal"
                                                        data-provinces="[['Aveiro','Aveiro'],['AÃ§ores','Azores'],['Beja','Beja'],['Braga','Braga'],['BraganÃ§a','BraganÃ§a'],['Castelo Branco','Castelo Branco'],['Coimbra','Coimbra'],['Faro','Faro'],['Guarda','Guarda'],['Leiria','Leiria'],['Lisboa','Lisbon'],['Madeira','Madeira'],['Portalegre','Portalegre'],['Porto','Porto'],['SantarÃ©m','SantarÃ©m'],['SetÃºbal','SetÃºbal'],['Viana do Castelo','Viana do Castelo'],['Vila Real','Vila Real'],['Viseu','Viseu'],['Ã‰vora','Ã‰vora']]">
                                                        Portugal</option>
                                                    ...
                                                    <option value="South Korea"
                                                        ...
                                                        South Korea</option>
                                                    <option value="Spain"
                                                        data-provinces="[['A CoruÃ±a','A CoruÃ±a'],['Albacete','Albacete'],['Alicante','Alicante'],['AlmerÃ­a','AlmerÃ­a'],['Asturias','Asturias Province'],['Badajoz','Badajoz'],['Balears','Balears Province'],['Barcelona','Barcelona'],['Burgos','Burgos'],['Cantabria','Cantabria Province'],['CastellÃ³n','CastellÃ³n'],['Ceuta','Ceuta'],['Ciudad Real','Ciudad Real'],['Cuenca','Cuenca'],['CÃ¡ceres','CÃ¡ceres'],['CÃ¡diz','CÃ¡diz'],['CÃ³rdoba','CÃ³rdoba'],['Girona','Girona'],['Granada','Granada'],['Guadalajara','Guadalajara'],['GuipÃºzcoa','Gipuzkoa'],['Huelva','Huelva'],['Huesca','Huesca'],['JaÃ©n','JaÃ©n'],['La Rioja','La Rioja Province'],['Las Palmas','Las Palmas'],['LeÃ³n','LeÃ³n'],['Lleida','Lleida'],['Lugo','Lugo'],['Madrid','Madrid Province'],['Melilla','Melilla'],['Murcia','Murcia'],['MÃ¡laga','MÃ¡laga'],['Navarra','Navarra'],['Ourense','Ourense'],['Palencia','Palencia'],['Pontevedra','Pontevedra'],['Salamanca','Salamanca'],['Santa Cruz de Tenerife','Santa Cruz de Tenerife'],['Segovia','Segovia'],['Sevilla','Seville'],['Soria','Soria'],['Tarragona','Tarragona'],['Teruel','Teruel'],['Toledo','Toledo'],['Valencia','Valencia'],['Valladolid','Valladolid'],['Vizcaya','Biscay'],['Zamora','Zamora'],['Zaragoza','Zaragoza'],['Ãlava','Ãlava'],['Ãvila','Ãvila']]">
                                                        Spain</option>
                                        ...
                                        <fieldset>
                                            <input type="text" placeholder="City" aria-required="true" required />
                                        </fieldset>
                                        <fieldset>
                                            <input type="text" placeholder="Phone" aria-required="true" required />
                                        </fieldset>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-10 flex-wrap">
                                        ...
                                        <span class="tf-btn-nor style-small btn-hide-address cs-pointer">
                                            <span class="text-small">
                                                Cancel
                                            </span>
                                        </span>
                                ...
                                <div class="list-account-address">
                                    <div class="account-address-item">
                                        <h5 class="mb-20 fw-medium">Default</h5>
                                        <p class="text-small">themesflat</p>
                                        <p class="text-small">1234 Fashion Street, Suite 567</p>
                                        <p class="text-small">New York</p>
                                        <p class="text-small">info@fashionshop.com</p>
                                        <p class="mb-10 text-small">(212) 555-1234</p>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <button
                                                class="tf-btn-nor style-small justify-content-center btn-edit-address">
                                                <span class="text-small">Edit</span>
                                            </button>
                                            <button class="tf-btn-nor style-small style-2 justify-content-center">
                                    ...
                                    <div class="account-address-item">
                                        ...
                                        <div class="d-flex gap-10 justify-content-center">
                                            ...
                                            <button
                                                class="tf-btn-nor style-small style-2 animate-hover-btn justify-content-center">
                                                <span class="text-small">Delete</span>
                                            </button>
                                        </div>
                                        <form class="edit-form-address wd-form-address" id="formeditAddress" action="#">
    ...
    <div class="offcanvas offcanvas-start canvas-filter canvas-sidebar canvas-sidebar-account" id="mbAccount">
        <div class="canvas-wrapper">
            <header class="canvas-header">
                <span class="title text-def fw-semibold">SIDEBAR ACCOUNT</span>
                <span class="icon-close icon-close-popup link cs-pointer" data-bs-dismiss="offcanvas"
