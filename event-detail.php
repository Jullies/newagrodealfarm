...
<!-- Mirrored from themesflat.co/html/donalfarm/event-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:11 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Page-title -->
        <div class="page-title page-event-detail">
            <div class="rellax" data-rellax-speed="5">
                <img src="images/page-title/event-detail.jpg" alt="">
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                ...
                                <div class="breadcrumb">
                                    ...
                                    <a href="javascript:void(0)">Our Events Detail </a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tf-container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="content">
                            <div class="swiper-container slider-event-detail">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="image">
                                            <img src="images/widget/slide-event.jpg"
                                                data-src="./images/widget/slide-event.jpg" alt="" class="lazyload">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image">
                                ...
                                <div class="btn-event-detail btn-next style-2">
                                    <i class="icon-arrow_right"></i>
                                </div>
                                <div class="btn-event-detail btn-prev style-2">
                                    <i class="icon-arrow_left"></i>
                                </div>
                            </div>
                            <h2 class="title fw-7 text-anime-style-1">
                                Discover Different Tours and Tasting
                                Offerings
                            </h2>
                            <p class="text-1">
                            ...
                            <div class="tour-infor">
                                ...
                                <ul class="tour-infor-list">
                                    <li>
                                        <p>Minimum of $60 for up to 4 guests; $10 for each additional guest</p>
                                    </li>
                                    <li>
                                        <p>Tours are Sunday through Thursday and start promptly at 11Am and then you are
                                            welcome
                                            to stay until 3pm</p>
                                    </li>
                                    <li>
                                        <p>Children 2 years old and under are free</p>
                                    </li>
                                    <li>
                                        <p>Tours by appointment only, using the booking calendar on this page</p>
                                    </li>
                                    <li>
                                        <p>Tours are refundable, minus a $3 cancellation fee, if canceled up to 48 hours
                                            prior</p>
                                    </li>
                                    <li>
                                        <p>Please do not herd, chase or yell at our animals. If any of them would like
                                            to be pet, they will
                                            come up to you </p>
                                    </li>
                                    <li>
                                        <p>Outside dogs and other pets are not allowed</p>
                                    </li>
                                    <li>
                                        <p>Close-toed shoes or boots able to get dirty are required for your safety.
                                            During the muddy months,
                                            ain boots are your best bet!</p>
                                    </li>
                                </ul>
                            </div>
                            <h2 class="title s2 fw-7">
                                Tour Schedule
                            </h2>
                                ...
                                <ul class="list">
                                    <li class="tf-img-hover wow fadeInUp" data-wow-delay="0s">
                                        <div class="image hover01">
                                            <img src="images/widget/portfolio-1.jpg"
                                                data-src="./images/widget/portfolio-1.jpg" alt="" class="lazyload">
                                        </div>
                                        <div class="text-wrap">
                                    ...
                                    <li class="tf-img-hover wow fadeInUp" data-wow-delay="0s">
                                        <div class="image hover01">
                                            <img src="images/widget/gallery-item-1.jpg"
                                                data-src="./images/widget/gallery-item-1.jpg" alt="" class="lazyload">
                                        </div>
                                        <div class="text-wrap">
                                    ...
                                    <li class="tf-img-hover wow fadeInUp" data-wow-delay="0s">
                                        <div class="image hover01">
                                            <img src="images/widget/tea.jpg" data-src="./images/widget/tea.jpg" alt=""
                                                class="lazyload">
                                        </div>
                                        <div class="text-wrap">
                                            <a href="event-detail.php" class="name-tour hover-text-4">Learn About the
                                                Production
                                                Process
                        ...
                        <div class="tf-sidebar-2">
                            <div class="sidebar-item-2 booking has-bg-2 mb-40">
                                ...
                                <form action="#" class="form-book">
                                    <fieldset class="choose-date mb-15">
                                        <label>Date to the farm</label>
                                        <input type="date" id="day" name="day" required>
                                        <span>
                                        </span>
                                    </fieldset>

                                    <fieldset class="choose-date-2 mb-15">
                                        <label>The time arrive at the farm</label>
                                        <input type="time" id="time" name="time" required>
                                    </fieldset>
                                    <fieldset class="amount mb-35">
                                        <input type="number" id="positiveNumber" name="positiveNumber" min="1"
                                            placeholder="Amount of people" required>
                                    </fieldset>
                                    <button type="submit"
                            ...
                            <div class="sidebar-map box-map style-3 mb-40">
                            ...
                            <div class="sidebar-item-2 get-in img-hover">
                                ...
                                <div class="content">
                                    ...
                                    <a href="contact-us.php" class="tf-btn-read text-white hover-text-secondary">
                                        Contact Us
                                        Today</a>
                                </div>
                            </div>
...
<!-- Mirrored from themesflat.co/html/donalfarm/event-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:16 GMT -->
</html>
