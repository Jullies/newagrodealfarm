...
<!-- Mirrored from themesflat.co/html/donalfarm/home-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:39:08 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    ...
    <div id="wrapper">
                            ...
                            <div class="topbar-right">
                                ...
                                <div class="icon-wrap">
                                    <a class="icon header-search" href="#canvasSearch" data-bs-toggle="offcanvas">
                                        <i class="icon-magnifying-glass fs-25"></i>
                                    </a>
                                    ...
                                    <ul class="nav-list">
                                        <li class="item has-child current-menu">
                                            ...
                                            <ul class="sub-nav">
                                                ...
                                                <li><a href="home-2.php"><span>
                                                            Home 2
                                                        </span>
                                                    </a></li>
                                                <li class="current-item"><a href="home-3.php"><span>
                                                            Home 3
                                                        </span>
                                                    </a></li>
                                            </ul>
                            ...
                            <div class="inner-mobile-nav overflow-y-auto">
                                <div class="top">
                                        ...
                                        <ul id="menu-mobile-menu" class="menu">
                                            <li class="menu-item menu-item-has-children-mobile ">
                                                ...
                                                <ul class="sub-menu-mobile">
                                                    ...
                                                    <li class="menu-item current"><a href="home-3.php">Home 3</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-has-children-mobile">
                                            ...
                                            <li class="menu-item menu-item-has-children-mobile">
                                                ...
                                                <ul class="sub-menu-mobile">
                                                    ...
                                                    <li class="menu-item"><a href="portfolio-style-1.php">Portfolio
                                                            Style
                                                            1</a></li>
                                                    <li class="menu-item"><a href="portfolio-style-2.php">Portfolio
                                                            Style
                                                            2</a></li>
                                                    <li class="menu-item"><a href="portfolio-style-3.php">Portfolio
                                                            Style
                                                            3</a></li>
                                            ...
                                            <li class="menu-item menu-item-has-children-mobile">
                                                ...
                                                <ul class="sub-menu-mobile">
                                                    <li class="menu-item"><a href="blog-full-width.php">Blog Full
                                                            Width</a>
                                                    </li>
                                                    <li class="menu-item "><a href="blog-right-sidebar.php">Blog Right
                                                            Sidebar</a>
                                                    </li>
                                                    <li class="menu-item "><a href="blog-single.php">Blog Single</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-has-children-mobile">
                                    ...
                                    <div class="group-icon">
                                        ...
                                        <a href="shop-products.php" class="site-nav-icon wg-bag">
                                            <i class="icon-basket"></i>
                                            Shop
                                        </a>
                                    </div>
        ...
        <div class="page-title-home-3">
            <div class="swiper-container slider-home-3">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-home-3 overflow-hidden">
                            <div class="image tf-animate-zoom-in-out">
                                <img src="images/page-title/home-3-2.jpg" data-src="images/page-title/home-3-2.jpg"
                                    alt="" class="lazyload">
                            </div>
                            <div class="content-wrap">
                                <div class="content">
            ...
            <div class="img-item item-2">
                <img src="images/item/rice-plant.png" alt="">
            </div>
            <div class="img-item item-3">
                <img src="images/item/corn.png" alt="">
            </div>
        </div><!-- /.Page-title-home-3 -->

        <!-- Section our-agriculture-2 -->
        <section class="s-our-agriculture style-2">
                        ...
                        <div class="col-lg-5">
                            <div class="image-wrap img-hover">
                                <div class="image hover-item">
                                    <img src="images/section/s-farm-2.jpg" data-src="images/section/s-farm-2.jpg"
                                        alt="" class="lazyload">
                                </div>
                                <div class="wg-exprerience text-center z-5 scroll-element tf-rotate-back-and-forth">
                                    <p class="year">65</p>
                                    <p class="text">
                        ...
                        <div class="col-lg-7">
                            <div class="content">
                                <div class="heading-section style-3 has-text">
                                    <div class="img-item mb-25">
                                        <img class="tf-animate-1" src="images/item/rice-plant-2.png" alt="" />
                                    </div>
                                    <p class="sub-title">Every Day Is A Good Day To Be A Farmer</p>
                                    <p class="title mb-24 text-anime-style-1">
                                ...
                                <a href="about-us.php" class="tf-btn btn-more bg-white">
                                    <span class="text-style cl-primary">
                                        More About Us
                                    </span>
            ...
            <div class="s-img-item item-1 wow zoomIn" data-wow-delay="0.2s">
                <div class="scroll-element-4">

                    <img src="images/item/windmill-2.png" data-src="./images/item/windmill-2.png" alt=""
                        class=" lazyload">
                </div>
            </div>
            <div class="s-img-item item-2">
                <img src="images/item/grass-3.png" data-src="./images/item/grass-3.png" alt="" class=" lazyload">
            </div>
        </section><!-- /.Section our-agriculture-2 -->

        <!-- Section our mission -->
        <section class="s-our-mission has-img-item">
            <div class="tf-container w-1780">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="content-section">
                            <div class="slider-wrap">
                                <div class="swiper-container slider-s-our-mission">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="content wow fadeInUp" data-wow-delay="0s">
                                                <p class="title fw-7 font-worksans">
                                                    Our Mission
                                                </p>
                                    ...
                                    <div class="btn-slide-wrap">
                                        <div class=" btn-slide-our-mission btn-prev">
                                        ...
                                        <div class=" btn-slide-our-mission btn-next">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="58px"
                                                height="15px" viewBox="0 0 80 20" preserveAspectRatio="xMidYMid meet">
                                                <g fill="#6a5030">
                                                    <path
            ...
            <div class="s-img-item item-1 z-5">
                <img src="images/item/page-title-top.png" alt="" />
            </div>
        ...
        <section class="s-our-expertise">
            <div class="heading-section text-center has-text has-img-item  mt-0">
                ...
                <div class="image">
                    ...
                    <img class="" src="images/item/gree-field.jpg" alt="" />
                </div>
                <div class="img-item item-2">
                    <img src="images/item/page-title-top.png" alt="" />
                </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card-provide img-hover">
                                            <div class="has-border ">
                                                ...
                                                <div class="image hover-item ">
                                                    <img src="images/widget/card-provide-1.jpg"
                                                        data-src="./images/widget/card-provide-1.jpg" alt=""
                                                        class="lazyload">
                                                </div>
                                                <a href="service-detail.php"
                                            ...
                                            <div class="has-border ">
                                                ...
                                                <div class="image hover-item">
                                                    <img src="images/widget/card-provide-2.jpg"
                                                        data-src="./images/widget/card-provide-2.jpg" alt=""
                                                        class="lazyload">
                                                </div>
                                                <a href="service-detail.php"
                                                    class="title text-upper font-worksans hover-text-secondary">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card-provide img-hover">
                                            <div class="has-border ">
                                                <div class="image hover-item">
                                                    <img src="images/widget/card-provide-3.jpg"
                                                        data-src="./images/widget/card-provide-3.jpg" alt=""
                                                        class="lazyload">
                                                </div>
                                                <a href="service-detail.php"
                                                    class="title text-upper font-worksans hover-text-secondary">
        ...
        <!-- Section quality of life 2-->
        <section class="s-quality-of-life-2">
            <div class="tf-container w-1290">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="content-section text-center">
                            <div class="img-item item-1  tf-animate__box">
                                <img class="lazyload up-down-move" src="images/item/notice-2.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="swiper-container slider-boxicon-2">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="box-icon style-4 ic-hover wow fadeInUp" data-wow-delay="0s">
        ...
        <section class="s-why-choose">
            ...
            <div class="s-img-item item-1 scroll-element-2">
                <img src="images/item/corn-4.png" alt="">
            </div>
        ...
        <section class="s-project-2 has-img-item tf-pt-0">
            <div class="s-content-wrap">
                        ...
                        <div class="col-lg-12">
                            <div class="content-section relative z-5">
                                <div class=" heading-section">
                                    ...
                                    <p class="title mb-20 tf-animate-4">Latest Projects List</p>
                                    <div class="img-item">
                                        <img class="tf-animate-1" src="images/item/rice-plant-2.png" alt="" />
                                    </div>
                                </div>
                                ...
                                <a href="portfolio-style-1.php" class="tf-btn-read text-white hover-text-secondary">
                                    View All Latest
                                    Projects</a>
                            </div>
                        </div>
                ...
                <div class="s-img-item item-2">
                    <img src="images/item/item-bottom.png" alt="" class="">
                </div>
                <div class="s-img-item item-3 wow zoomIn">
                    <div class="scroll-element-3">
                        <img src="images/item/windmill.png" alt="" class="">
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="wrap">
                                    ...
                                    <ul class="overflow-x-auto menu-tab">
                                        ...
                                        <li class="item"><a href="javascript:void(0)" class="btn-tab wow fadeInUp"
                                                data-wow-delay="0.3s">Harvest</a></li>
                                        <li class="item"><a href="javascript:void(0)" class="btn-tab wow fadeInUp"
                                                data-wow-delay="0.4s">Vegetable</a></li>
                                        <li class="item"><a href="javascript:void(0)" class="btn-tab wow fadeInUp"
                                                data-wow-delay="0.5s">Fruit</a></li>
                                        <li class="item"><a href="javascript:void(0)" class="btn-tab wow fadeInUp"
                                                data-wow-delay="0.6s">Cattle</a></li>
                                    </ul>
                                    <div class="btn-slide-wrap">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="box-portfolio-2 img-hover">
                                            <div class="image hover-item">
                                                <img src="images/widget/portfolio-1-style-2.jpg"
                                                    data-src="./images/widget/portfolio-1-style-2.jpg" alt=""
                                                    class="lazyload">
                                            </div>
                                            <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-portfolio-2 img-hover">
                                            <div class="image hover-item">
                                                <img src="images/widget/portfolio-2-style-2.jpg"
                                                    data-src="./images/widget/portfolio-2-style-2.jpg" alt=""
                                                    class="lazyload">
                                            </div>
                                            <div class="content">
                                                <p class="sub font-farmhouse text-upper">Agriculture - farm</p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-portfolio-2 img-hover">
                                            <div class="image hover-item">
                                                <img src="images/widget/portfolio-3-style-2.jpg"
                                                    data-src="./images/widget/portfolio-3-style-2.jpg" alt=""
                                                    class="lazyload">
                                            </div>
                                            <div class="content">
                                                <p class="sub font-farmhouse text-upper">Agriculture - farm</p>
        ...
        <!-- Section partner -->
        <section class="s-partner style-3 ">
            <div class="tf-container w-1780">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="slider-wrap">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="slide-partner">
                                            <div class="image">
                                                <a href="#">
                                                    ...
                                                    <img src="images/partner/wide-open.png" alt="" class="lazyload">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slide-partner">
                                            ...
                                            <div class="image">
                                                <a href="#">
                                                    <img src="images/partner/new-holland.png" alt="" class="lazyload">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slide-partner">
                                            ...
                                            <div class="image">
                                                <a href="#">
                                                    <img src="images/partner/stony-field.png" alt="" class="lazyload">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- Section break page  -->
        <section class="s-break-page style-3">
            <div class="image ">
                <img src="images/section/break-page.png" data-src="./images/section/break-page.png" alt=""
                    class="lazyload">
            </div>
            <div class="content">
                <h1 class="text text-center font-farmhouse text-anime-style-1">
                    The Best Agriculture <br>
                    Harvest in the World
                </h1>
                <div class="img-item">
                    <img class="tf-animate-1" src="images/item/line-throw-title-2.png" alt="">
                </div>
            </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="card-product mw-unset style-2 type-2 wow fadeInUp"
                                                ...
                                                <div class="image">
                                                    <img src="images/item/strawberry.png"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card-product mw-unset style-2 type-2 wow fadeInUp"
                                                ...
                                                <div class="image">
                                                    <img src="images/item/eggs.png" data-src="images/item/eggs.png"
                                                        alt="" class=" lazyload">
                                                </div>
                                                <a href="shop-details.php"
                                                    class="name-product font-worksans hover-text-4">
        ...
        <!-- Section close project 2 -->
        <section class="s-farm-event has-img-item s-project-2 tf-pt-0">
            <div class="s-content-wrap">
                <div class="tf-container w-1290">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content-section">
                                <div class="heading-section">
                                    <p class="sub-title">Farm Event</p>
                                    <p class="title mb-21 wow fadeInUp" data-wow-delay="0s">Event Is Taking Place</p>
                                    <div class="img-item">
                                        <img class="tf-animate-1" src="images/item/rice-plant-2.png" alt="" />
                                    </div>
                                </div>
                                <p class="text">
                                    There are many variations of passages of lorem wallpaper Ipsum
                                    available, but the majority have suffered alteration in some form
                                    odio dignissimos ducimus qui blanditiis.
                                </p>
                                <div class="btn-right">

                                    <a href="our-events.php" class="tf-btn-read text-white hover-text-secondary"> View
                                        All Events</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="s-img-item item-2">
                    <img src="images/item/green.png" alt="" class="">
                </div>
                ...
                <div class="s-img-item item-3 wow zoomIn">
                    <div class="scroll-element-4">
                        ...
                        <img src="images/item/barn-3.png" alt="" class="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="swiper-container slider-box-event">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="box-event img-hover wow fadeInUp" data-wow-delay="0s">
                                            <div class="image hover-item">
                                            ...
                                            <div class="content">
                                                ...
                                                <a href="event-detail.php" class="title fw-7 font-worksans">
                                                    Discover Farm Tour
                                                </a>
                                                <p class="text">
                                                    Lorem ipsum dolor
                                                ...
                                                <a href="our-events.php" class="tf-btn-read hover-text-4">Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="box-event img-hover wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="image hover-item">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-event img-hover wow fadeInUp" data-wow-delay="0.2s">
                                            <div class="image hover-item">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section has-text text-center mb-81">
                            ...
                            <p class="title fadeInUp" data-wow-delay="0s">Latest News & Articles</p>
                            <p class="text">
                                    ...
                                    <div class="swiper-slide">
                                        <article class="article-blog-item type-3 style-2 img-hover wow fadeInUp"
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bot">
                                                    <a href="blog-single.php" class="tf-btn-read hover-text-4">Continue
                                                        Reading</a>
                                                </div>
                                            </div>
                                        </article>
        ...
        <section class="s-happy-farm-2 has-img-item tf-pt-0">
                            ...
                            <div class="heading-section style-3 has-text">
                                <div class="top">
                                    ...
                                    <div class="img-item item-2 tf-heartBeat">
                                        <img class="wow zoomIn" src="images/item/happy.png" alt="" />
                                    </div>
                                </div>
                                <p class="title wow fadeInUp" data-wow-delay="0s">
            ...
            <div class="s-img-item item-2 tf-animate__rotate-right ">
                <img class="up-down-move" src="images/item/leaf-3.png" alt="">
            </div>
                                ...
                                <div class="sib-form w-100">
                                    <div id="sib-form-container" class="sib-form-container">
                                        ...
                                        <div id="sib-container" class="sib-container--large sib-container--vertical">
                                            <form id="sib-form" method="POST" class="d-block form-newsletter form-email style-3"
                                                ...
                                                <div class="w-100">
                                                    <div class="sib-form-block">
                                                        <button class="sib-form-block__button sib-form-block__button-with-loader btn-send" form="sib-form" type="submit">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                        ...
                        <tbody>
                            <tr class="wishlist-item file-delete">
                                ...
                                <td class="wishlist-item_image">
                                    <a href="#">
                                        <img src="images/product/product-1.jpg" data-src="images/product/product-1.jpg"
                                            alt="" class="lazyload">
                                    </a>
                                </td>
                                <td class="wishlist-item_info">
                                    <div class="wishlist_name"><a href="#" class="text-def text-main-2 link">Vimto
                                            Squash Remix</a></div>
                                    <p class="wishlist_price">18.00$</p>
                            ...
                            <tr class="wishlist-item file-delete">
                                ...
                                <td class="wishlist-item_image">
                                    <a href="#">
                                        <img src="images/product/product-2.jpg" data-src="images/product/product-2.jpg"
                                            alt="" class="lazyload">
                                    </a>
                                </td>
                                <td class="wishlist-item_info">
                ...
                <div class="content-bottom d-flex justify-content-between">
                    <a href="wishlist.php" class="text-small text-uppercase link text-decoration-underline">Open
                        wishlist page</a>
            ...
            <div class="modal-content">
                ...
                <ul class="mini-cart-list">
                    <li class="mini-cart-item file-delete">
                        ...
                        <div class="remove w-auto cs-pointer link">
                            <i class="icon-close"></i>
                        </div>
                    </li>
                    <li class="mini-cart-item file-delete">
                ...
                <div class="content-bottom d-flex justify-content-between">
                    <div class="box-price">
                        ...
                        <p class="text-lg fw-bold text-main-2">98.00$</p>
                    </div>
                    <div class="box-btn">
                        <a href="checkout.php" class="tf-btn-nor">Checkout</a>
                        <a href="shop-cart.php" class="tf-btn-nor">View Cart</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from themesflat.co/html/donalfarm/home-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:39:29 GMT -->
</html>
