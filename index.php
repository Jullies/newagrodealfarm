                            ...
                            <div class="content-wrap">
                                <div class="content">
                                    <p class="sub-title font-snowfall tf-fade-top fade-item-1">
                                        New Agrodeal Kenya Limited · Solai-grown, export-ready quality
                                    </p>
                                    <h1 class="title font-farmhouse tf-fade-right fade-item-2">
                                        Organic Herbs & Flowers <br />
                                    ...
                                    <p class="text font-nunito tf-fade-left fade-item-4">
                                        Grown sustainably in Solai, Kenya, our basil, mint, coriander, chives, tarragon and specialty herbs are picked at peak aroma, graded with care, and packed to customer specifications for dependable international supply.
                                    </p>
                        ...
                        <div class="slide-home-1">
                            ...
                            <div class="content-wrap">
                                <div class="content">
                                    ...
                                    <p class="text font-nunito tf-fade-left fade-item-4">
                                        We combine sustainable farming, field discipline, and cold-chain readiness to deliver consistent flavor, vibrant color, and export-quality herbs and flowers to markets worldwide.
                                    </p>
                                    <a href="our-services.php"
                                        class="tf-btn btn-view bg-white tf-fade-bottom fade-item-5">
                                        <span class="text-style cl-primary">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-home-1">
                            ...
                            <div class="content-wrap">
                                <div class="content">
                                    <p class="sub-title font-snowfall tf-fade-top fade-item-1">
                                        Trusted Solai exporter of premium, organic herbs and Gypsophila
                                    </p>
                                    <h1 class="title font-farmhouse tf-fade-right fade-item-2">
                                        Reliable Supply, <br />
                                    ...
                                    <p class="text font-nunito tf-fade-left fade-item-4">
                                        From seed to harvest we maintain traceability, careful grading, and customer-focused packing so every shipment arrives fresh, aromatic, and aligned to your specifications.
                                    </p>
                                    <a href="our-services.php"
                                        class="tf-btn btn-view bg-white tf-fade-bottom fade-item-5">
                                        <span class="text-style cl-primary">
                        ...
                        <div class="col-lg-4">
                            <div class="box-portfolio style-4 tf-img-hover mb-s-991">
                                ...
                                <div class="content">
                                    ...
                                    <a href="our-services.php" class="title fs-22 font-worksans fw-6 hover-text-4">
                                    ...
                                    <div class="bot">
                                        <a href="our-services.php" class="btn-read font-worksans fw-5">
                                            Read More
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="box-portfolio style-4 tf-img-hover">
                                ...
                                <div class="content">
                                    ...
                                    <a href="our-services.php" class="title fs-23 font-worksans fw-6 hover-text-4">
                                ...
                                <div class="content-left img-hover">
                                    <div class="heading-section">
                                        <p class="sub-title wow fadeInUp" data-wow-delay="0s">
                                            Founded in 2015 · Solai, Kenya · Sustainable, organic growing
                                        </p>
                                        <p class="title text-container tf-animate-2">
                                            Exporting premium herbs, vegetables, and Gypsophila with consistent quality
                                        </p>
                                    </div>
                                    <p class="text-1">
                                        New Agrodeal Kenya Limited grows and packs in Solai, delivering basil, mint,
                                        coriander, chives, tarragon, and a wide range of specialty herbs at peak
                                        freshness. Every crop is nurtured with a sustainability-first mindset for
                                        vibrant aroma, color, and taste.
                                    </p>
                                    <p class="text-2">
                                        From seed to harvest we maintain traceability, careful grading, and customer
                                        specification packing to keep every shipment export-ready. Our certified
                                        exporter status and disciplined cold-chain handling support reliable delivery to
                                        multiple international markets.
                                    </p>
                                    <a href="about-us.php" class="tf-btn btn-read-more gap-34">
                                        ...
                                        <div class="has-border">
                                            <div class="counter-item">
                                                ...
                                                <div class="counter">
                                                    ...
                                                    <p class="text font-nunito">
                                                        Trusted by global buyers for consistent volumes, flavor-rich
                                                        herbs, and responsive service from our Solai operations.
                                                    </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="has-border">
                                            <ul class="benefit-list ">
                                                <li>
                                                    ...
                                                    <p>
                                                        Sustainable, organic field discipline
                                                    </p>
                                                </li>
                                                <li>
                                                    <i class="fa-solid fa-circle-check"></i>
                                                    <p>
                                                        Peak-freshness harvesting and fast cooling
                                                    </p>
                                                </li>
                                                <li>
                                                    <i class="fa-solid fa-circle-check"></i>
                                                    <p>
                                                        Careful grading, packing, and reliable export supply
                                                    </p>
                                                </li>
                                            </ul>
                                            ...
                                            <a href="about-us.php" class="tf-btn-read text-white hover-text-secondary">
                                                Read More
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="box-icon style-6 ic-hover wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <a href="service-detail.php" class="caption fw-6 font-worksans hover-text-secondary">
                                    Pure Cow's Milk
                                </a>
                                <p class="text font-nunito">
                                    Ultrices sagittis orci a scelerisque
                                ...
                                <a href="service-detail.php" class="btn-read">
                                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="80px" height="20px"
                                        viewBox="0 0 80 20" preserveAspectRatio="xMidYMid meet">
                                        <g fill="#ffffff">
                                            <path
                                ...
                                <div class="content-section">
                                    <div class="heading-section style-2">
                                        <div class="img-item">
                                            ...
                                            <p class="sub-title">
                                                Why Choose New Agrodeal Kenya Limited?
                                            </p>
                                        </div>

                                        <p class="title tf-animate-4">
                                            Export-ready crops grown with disciplined care in Solai
                                        </p>
                                    </div>
                                    <p class="text">
                                        Grown with a sustainability-first mindset and harvested at peak freshness for
                                        superior aroma and flavor. We maintain traceability, careful grading, and
                                        customer-focused packing so every box of basil, mint, coriander, chives,
                                        tarragon, specialty herbs, and Gypsophila arrives consistent and export-ready.
                                    </p>
                                    <a href="our-history.php" class="tf-btn btn-read-more scale-40">
                                        <span class="text-style">
                                            More Why Choose Us
                                        </span>
                                        <div class="icon">
                            ...
                            <div class="bot relative">
                                <ul class="benefit-list">
                                    <li>
                                        ...
                                        <p class="sub">
                                            Field discipline, soil care, and responsible inputs deliver clean, flavorful
                                            herbs customers trust.
                                        </p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <p class="sub">
                                            Harvested at peak freshness, graded for uniformity, and packed to match
                                            buyer specifications every time.
                                        </p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <p class="sub">
                                            Sustainable irrigation, waste reduction, and a Solai-based team committed
                                            to protecting the land we grow on.
                                        </p>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="main-section">
                                <div class="content-section">
                                    ...
                                    <a href="our-commitments.php" class="tf-btn btn-read-more scale-50">
                                        <span class="text-style">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="bot">
                                    ...
                                    <a href="portfolio-style-1.php" class="tf-btn-read hover-text-4">View All Latest
                                        Projects</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="s-right img-hover">
                                ...
                                <div class="content">
                                    ...
                                    <a href="faq.php" class="tf-btn bg-white">
                                        <span class="text-style cl-primary">
                                            Read More
                                        </span>
                                        <div class="icon">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box-event ">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <a href="our-events.php" class="tf-btn-read hover-text-4">Read
                                                        More</a>
                                                </div>
                                            </div>
                                        </div>
