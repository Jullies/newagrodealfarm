...
<!-- Mirrored from themesflat.co/html/donalfarm/gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:17 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                                ...
                                <div class="widget-content-inner active">
                                    <div class="wg-gallery">
                                        <div class="gallery-item item-1 wow fadeInUp" data-wow-delay="0s">
                                            <div class="image">
                                                <img class="lazyload" src="images/widget/gallery-item-1.jpg"
                                                    data-src="./images/widget/gallery-item-1.jpg" alt="">
                                            </div>
                                        ...
                                        <div class="gallery-item item-2 wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="image">
                                                <img class="lazyload" src="images/widget/gallery-item-2.jpg"
                                                    data-src="./images/widget/gallery-item-2.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">+</a>

                                        </div>
                                        <div class="gallery-item item-3 wow fadeInUp" data-wow-delay="0.2s">
                                            <div class="image">
                                                <img class="lazyload" src="images/widget/gallery-item-3.jpg"
                                                    data-src="./images/widget/gallery-item-3.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">+</a>
                                        ...
                                        <div class="gallery-item item-5 wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="image">
                                                <img class="lazyload" src="images/widget/gallery-item-5.jpg"
                                                    data-src="./images/widget/gallery-item-5.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">+</a>
                                        ...
                                        <div class="gallery-item item-6 wow fadeInUp" data-wow-delay="0s">
                                            <div class="image">
                                                <img class="lazyload" src="images/widget/gallery-item-6.jpg"
                                                    data-src="./images/widget/gallery-item-6.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">+</a>
                                        ...
                                        <div class="gallery-item item-8 wow fadeInUp" data-wow-delay="0.2s">
                                            <div class="image">
                                                <img class="lazyload" src="images/widget/gallery-item-8.jpg"
                                                    data-src="./images/widget/gallery-item-8.jpg" alt="">
                                            </div>
                                            <a href="gallery.php" class="add-gallery">+</a>
...
<!-- Mirrored from themesflat.co/html/donalfarm/gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:22 GMT -->
</html>
