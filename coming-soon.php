...
<!-- Mirrored from themesflat.co/html/donalfarm/coming-soon.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:09 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
        ...
        <div class="wg-coming-soon">
            <div class="content">
                <div class="top">
                    ...
                    <p class="title font-farmhouse">
                        Coming soon
                    </p>
                    <div class="img-item">
                        <img src="images/item/line-throw-title-3.png" alt="">
                    </div>
                </div>
                <p class="caption font-worksans fw-7">
                    Grape Harvest Season In August
                ...
                <p class="notice font-worksans fw-6">
                    Get Notified When The Event Starts
                </p>
                <div class="bot">
                    <div class="sib-form w-100">
                        <div id="sib-form-container" class="sib-form-container">
                            ...
                            <div id="sib-container" class="sib-container--large sib-container--vertical">
                                <form id="sib-form" method="POST" class="d-block form-newsletter form-email style-3 type-1"
                    ...
                    <a href="index.php" class="tf-btn-read text-white hover-text-secondary"> Back To Homepages</a>
                </div>
                <div class="img-item item-2 tf-rotate-back-and-forth">
                    <img src="images/item/corn-3.png" alt="">
                </div>
            </div>
            <div class="image">
                <img src="images/section/coming-soon.jpg" data-src="./images/section/coming-soon.jpg" alt=""
                    class="lazyload">
            </div>
        </div><!-- /.Wg coming -->
    </div><!-- /#Wapper -->
...
<!-- Mirrored from themesflat.co/html/donalfarm/coming-soon.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:40:10 GMT -->
</html>
