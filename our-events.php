...
<!-- Mirrored from themesflat.co/html/donalfarm/our-events.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:39:45 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                ...
                                <div class="breadcrumb">
                                    ...
                                    <a href="javascript:void(0)">Our Events </a>
        ...
        <!-- Main-content -->
        <div class="main-content page-our-events pb-0 mb--20">
            ...
            <section class="s-video">
                        ...
                        <div class="col-lg-6">
                            <div class="content-section">
                                <div class="heading-section style-4">
                                    <div class="img-item">
                                        <img class="" src="images/item/rice-plant-2.png" alt="" />
                                    </div>

                                    <p class="title text-anime-style-1">
                                        Great Experience At <br>
                                        The Farm Discovery Tour
                ...
                <div class="s-img-item wow zoomIn " data-wow-offset="10">
                    <div class="tf-rotate-back-and-forth">
            ...
            <!-- Section banner -->
            <section class="s-banner style-2">
                <div class="heading-side has-img-item">
                    <div class="image">
                        <div class="scroll-element-4">

                            <img class="scale-1-1" src="images/section/s-bg-banner.jpg" alt="" />
                        </div>
                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box-event img-hover wow fadeInUp" data-wow-delay="0s"
                                                ...
                                                <div class="content">
                                                    ...
                                                    <a href="event-detail.php" class="tf-btn-read hover-text-4">Read
                                                        More</a>
                                                </div>
                                            </div>
                                        </div>
            ...
            <!-- Section other event -->
            <section class="s-other-event">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="heading-section style-4 has-text">
                                <div class="img-item">
                                    <img class="tf-animate-1" src="images/item/rice-plant-2.png" alt="" />
                                </div>

                                <p class="title mb-18 text-anime-style-2">
                        ...
                        <div class="col-lg-12">
                            <div class="our-event-item img-hover tf-img-hover mb-50 wow fadeInUp" data-wow-delay="0s"
                                data-wow-offset="10">
                                <div class="image relative hover-item hover14">
                                    <img src="images/widget/our-event-1.jpg"
                                        data-src="./images/widget/our-event-1.jpg" alt="" class=" lazyload">
                                    <div class="price-wrap absolute">
                                        <span class="dollar">
                                            $
                                        </span>
                                        <span class="price">
                                ...
                                <div class="content">
                                    <a href="event-detail.php" class="hover-text-4 fs-30 title fw-7 font-worksans">
                        ...
                        <div class="col-lg-12">
                            <div class="our-event-item img-hover tf-img-hover mb-50 wow fadeInUp" data-wow-delay="0s"
                                data-wow-offset="10">
                                <div class="image relative hover-item hover14">
                                    <img src="images/widget/our-event-2.jpg"
                                        data-src="./images/widget/our-event-2.jpg" alt="" class=" lazyload">
                                    <div class="price-wrap absolute">
                                        <span class="free">
                                            Free!
                                        </span>
                        ...
                        <div class="col-lg-12">
                            <div class="our-event-item img-hover tf-img-hover wow fadeInUp" data-wow-delay="0s"
                                data-wow-offset="10">
                                <div class="image relative hover-item hover14">
                                    <img src="images/widget/our-event-3.jpg"
                                        data-src="./images/widget/our-event-3.jpg" alt="" class=" lazyload">
                                    <div class="price-wrap absolute">
            ...
            </section><!-- /.Section other event -->

            <!-- Section question -->
            <section class="s-question has-img-item">
                <div class="content-wrap">
                    <div class="content">
                        <div class="heading-section style-4 has-text">
                            ...
                            <p class="text">
                                We will reply you within 24 hours or you can refer to the questions at the
                                FAQs
                                Page.
                            </p>
                        </div>
                        ...
                        <div class="bot">
                            <a href="contact-us.php" class="tf-btn wow fadeInUp" data-wow-delay="0s"
                                data-wow-offset="10">
                                <span class="text-style">Contact Us Today</span>
                                <div class="icon"><i class="icon-arrow_right"></i></div>
                            </a>
                            <a href="faq.php" class="tf-btn style-3 pd-defalt wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="image-wrap">
                        <div class="image">
                            <img src="images/section/s-contact-2.jpg" data-src="images/section/s-contact-2.jpg"
...
<!-- Mirrored from themesflat.co/html/donalfarm/our-events.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 17:39:54 GMT -->
</html>
